function addIng(){
    ...
    var nextIngredient="<input class='mb-2 block border-2 border-black border-single rounded-md' type='text' name='ingList' id='ing_"+newIngredient+"'>";
  ...
  function addStep(){
    ...
    var nextStep="<input class='mb-2 block border-2 border-black border-single rounded-md' type='text' name='stepList' id='step_"+newStep+"'>";
